...
cleanTracts00 <- 
  ...
  rename(TotalPop = P001001, 
	...
	mutate(MedRentAdjusted = (MedRent * 1.423),
...
# Trends in Crime, Transit, and Housing
```{r}
# Read in crime data
crime08 <- st_read("https://opendata.arcgis.com/datasets/180d56a1551c4e76ac2175e63dc0dce9_32.geojson") %>%
	st_transform('ESRI:102746')
